  ...
  const mutation = useMutation({
    mutationFn: (values: FormValues) => {
      const payload = {
        ...
        role: values.role ?? '',
        startedWithMeAt: values.startedWithMeAt ?? '',
        endedWithMeAt: values.endedWithMeAt ?? '',
        firstJobAt: contratoMasAntiguo ?? values.firstJobAt ?? '',
        studyPlace: values.studyPlace ?? '',
        studyStartAt: values.studyStartAt ?? '',
        studyEndAt: values.studyEndAt ?? '',
